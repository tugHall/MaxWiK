...
#'
#' @examples
#' MaxWiK::MaxWiK_templates(dir = tempdir()) # See the template 'MaxWiK.Sampling.R' and vignettes for usage. For parallel implementation change the function \code{sampler_MaxWiK()} to \code{sampler_MaxWiK_parallel()}.
